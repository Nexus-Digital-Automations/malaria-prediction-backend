...
// in malaria_frontend/test/unit/intelligent_cache_interceptor_test.dart.
...
import 'package:malaria_frontend/core/cache/intelligent_cache_manager.dart'
    as _i4;
import 'package:malaria_frontend/core/cache/offline_cache_service.dart' as _i12;
...
class _FakeCacheStatistics_3 extends _i1.SmartFake
    implements _i4.CacheStatistics {
  _FakeCacheStatistics_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
/// A class which mocks [IntelligentCacheManager].
///
/// See the documentation for Mockito's code generation for more information.
class MockIntelligentCacheManager extends _i1.Mock
    implements _i4.IntelligentCacheManager {
  MockIntelligentCacheManager() {
  ...
  @override
  int get maxMemoryCacheMB => (super.noSuchMethod(
        Invocation.getter(#maxMemoryCacheMB),
        returnValue: 0,
      ) as int);

  @override
  int get maxDiskCacheMB => (super.noSuchMethod(
        Invocation.getter(#maxDiskCacheMB),
        returnValue: 0,
      ) as int);

  @override
  int get maxEncryptedCacheMB => (super.noSuchMethod(
        Invocation.getter(#maxEncryptedCacheMB),
        returnValue: 0,
      ) as int);

  @override
  Duration get memoryTtl => (super.noSuchMethod(
        Invocation.getter(#memoryTtl),
  ...
  @override
  Duration get diskTtl => (super.noSuchMethod(
        Invocation.getter(#diskTtl),
        returnValue: _FakeDuration_2(
          this,
          Invocation.getter(#diskTtl),
        ),
  ...
  @override
  Duration get encryptedTtl => (super.noSuchMethod(
        Invocation.getter(#encryptedTtl),
        returnValue: _FakeDuration_2(
          this,
          Invocation.getter(#encryptedTtl),
        ),
  ...
  _i11.Future<void> store({
    ...
    Duration? ttl,
    _i12.CachePriority? priority = _i12.CachePriority.normal,
    List<String>? tags = const [],
    String? etag,
    DateTime? lastModified,
    _i4.CacheLayer? preferredLayer,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #store,
  ...
  @override
  _i11.Future<Map<String, dynamic>?> retrieve(String? key) =>
      (super.noSuchMethod(
        Invocation.method(
          #retrieve,
          [key],
  ...
  @override
  _i11.Future<bool> contains(String? key) => (super.noSuchMethod(
        Invocation.method(
          #contains,
          [key],
        ),
  ...
  @override
  _i11.Future<void> clearByTags(List<String>? tags) => (super.noSuchMethod(
        Invocation.method(
          #clearByTags,
          [tags],
        ),
  ...
  @override
  _i11.Future<_i4.CacheStatistics> getStatistics() => (super.noSuchMethod(
        Invocation.method(
          #getStatistics,
          [],
        ),
        returnValue:
            _i11.Future<_i4.CacheStatistics>.value(_FakeCacheStatistics_3(
          this,
          Invocation.method(
            #getStatistics,
            [],
      ...
      ) as _i11.Future<_i4.CacheStatistics>);

  @override
  _i11.Future<void> warmCache(List<String>? criticalKeys) =>
      (super.noSuchMethod(
        Invocation.method(
          #warmCache,
          [criticalKeys],
  ...
  @override
  _i11.Future<void> preload({
    required String? key,
    required _i11.Future<Map<String, dynamic>>? dataProvider,
    Duration? ttl,
    _i12.CachePriority? priority = _i12.CachePriority.high,
    List<String>? tags = const [],
  }) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i11.Future<Map<String, dynamic>> exportCache({
    List<String>? tags,
    _i12.CachePriority? minPriority,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #exportCache,
  ...
  @override
  _i11.Future<void> importCache(Map<String, dynamic>? importData) =>
      (super.noSuchMethod(
        Invocation.method(
          #importCache,
          [importData],
...
class MockConnectivity extends _i1.Mock implements _i3.Connectivity {
  ...
  @override
  _i11.Stream<_i3.ConnectivityResult> get onConnectivityChanged =>
      (super.noSuchMethod(
        Invocation.getter(#onConnectivityChanged),
        returnValue: _i11.Stream<_i3.ConnectivityResult>.empty(),
      ) as _i11.Stream<_i3.ConnectivityResult>);

  @override
  _i11.Future<_i3.ConnectivityResult> checkConnectivity() =>
      (super.noSuchMethod(
        Invocation.method(
          #checkConnectivity,
          [],
        ),
        returnValue: _i11.Future<_i3.ConnectivityResult>.value(
            _i3.ConnectivityResult.bluetooth),
      ) as _i11.Future<_i3.ConnectivityResult>);
}
  ...
  _i11.Future<_i9.Response<T>> head<T>(
    ...
    _i13.CancelToken? cancelToken,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i11.Future<_i9.Response<T>>.value(_FakeResponse_8<T>(
          this,
          Invocation.method(
            #head,
            [path],
  ...
  _i11.Future<_i9.Response<dynamic>> download(
    ...
    _i5.Options? options,
      ...
      (super.noSuchMethod(
        ...
        returnValue:
            _i11.Future<_i9.Response<dynamic>>.value(_FakeResponse_8<dynamic>(
          this,
          Invocation.method(
            #download,
            [
