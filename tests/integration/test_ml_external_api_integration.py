...
from malaria_predictor.ml.models.transformer_model import TransformerModel
...
class TestEndToEndMLPipelineIntegration:
    ...
    async def test_complete_ml_pipeline_workflow(self):
        ...
        with (
            ...
            from malaria_predictor.services.prediction_pipeline import PredictionPipeline
    ...
    async def test_pipeline_error_resilience_workflow(self):
        ...
        with (
            ...
            from malaria_predictor.services.prediction_pipeline import ResilientPredictionPipeline
